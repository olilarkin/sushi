...
#ifndef SUSHI_JSFX_PROCESSOR_FACTORY_H
#define SUSHI_JSFX_PROCESSOR_FACTORY_H

#include "library/base_processor_factory.h"

namespace sushi::internal::jsfx_wrapper {

class JsfxProcessorFactory : public BaseProcessorFactory
{
public:
    ~JsfxProcessorFactory() override = default;
...
#endif // SUSHI_JSFX_PROCESSOR_FACTORY_H
