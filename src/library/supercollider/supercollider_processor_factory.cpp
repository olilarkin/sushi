...
#include "supercollider_processor_factory.h"
...
SuperColliderProcessorFactory::new_instance(const PluginInfo& plugin_info,
                                            HostControl& host_control,
                                            float sample_rate)
{
#ifdef SUSHI_BUILD_WITH_SUPERCOLLIDER
    auto processor = std::make_shared<SuperColliderWrapper>(host_control, plugin_info);
