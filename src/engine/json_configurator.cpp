                                                     ...
                                                     ObjectId track_id)
{
    ...
    {
        plugin_type = PluginType::FAUST;
        if (plugin_def.HasMember("path"))
        {
            plugin_path = plugin_def["path"].GetString();
        }
    }
    else if (type == "supercollider")
    {
        plugin_type = PluginType::SUPERCOLLIDER;
        if (plugin_def.HasMember("path"))
        {
            plugin_path = plugin_def["path"].GetString();
        }
    ...
    if ((plugin_type == PluginType::CMAJOR || plugin_type == PluginType::JSFX || plugin_type == PluginType::FAUST || plugin_type == PluginType::SUPERCOLLIDER) && plugin_def.HasMember("source_code"))
    {
